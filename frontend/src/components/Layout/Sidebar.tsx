...
const menuItems: MenuItem[] = [
  ...
  { key: 'text-center', icon: <FontColorsOutlined />, label: '文本中心', path: '/text-center' },
  ...
  { key: 'quality', icon: <SafetyOutlined />, label: '质量控制', path: '/quality' },
  { key: 'editor', icon: <EditOutlined />, label: '漫画编辑器', path: '/editor' },
  { key: 'export', icon: <ExportOutlined />, label: '导出中心', path: '/export' },
  { key: 'models', icon: <ApiOutlined />, label: '模型配置', path: '/models' },
  { key: 'resources', icon: <DatabaseOutlined />, label: '资源中心', path: '/resources' },
